...
my $actief = "J";
my $indicator_fiche_id = $fiches{'verdeling van woon-werkverplaatsingen volgens hoofdvervoerswijze (beroepsactieven)'};
$query = "SELECT d.vervoerswijze, procent, jaartal
          FROM `indicator verdeling woon-werkverplaatsingen hoofdvervoerswijze` i,

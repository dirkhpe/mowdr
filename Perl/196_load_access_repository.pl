...
load_access_repository - This script will load the translation table from excel.


=head1 VERSION HISTORY

version 1.0 06 January 2014 DV
...
=head1 SYNOPSIS
 ...
 load_access_repository.pl [-x data_mapping.xls file]


 load_access_repository -h	Usage
 load_access_repository -h 1  Usage and description of the options
 load_access_repository -h 2  All documentation
...
foreach my $worksheet ($workbook->worksheets()) {
	...
	if (index($worksheet_name,"Access Repository", 0) > -1) {

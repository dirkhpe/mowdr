...
load_txtable - This script will load the translation table from excel.
...
=head1 SYNOPSIS
 ...
 load_txtable.pl [-x data_mapping.xls file]

 load_txtable -h	Usage
 load_txtable -h 1  Usage and description of the options
 load_txtable -h 2  All documentation
...
foreach my $worksheet ($workbook->worksheets()) {
	...
	if (index($worksheet_name,"vertaaltabel", 0) > -1) {

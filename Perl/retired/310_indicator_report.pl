...
my $actief = "J";
my $indicator_fiche_id = $fiches{'verdeling van personen (beroepsactieven) volgens hoofdvervoerswijze woon-werkverkeer'};
$query = "SELECT d.vervoerswijze, procent, jaartal
          FROM `indicator verdeling personen hoofdvervoerswijze woon-werk` i,
